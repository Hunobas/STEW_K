...
void APlanetPlayerController::ShowWinGame()
{
    if (WinGameClass)
    {
        UUserWidget* WinWidget = CreateWidget<UUserWidget>(this, WinGameClass);
        if (WinWidget)
        {
...
void APlanetPlayerController::ShowLoseGame()
{
    if (LoseGameClass)
    {
        UUserWidget* LoseWidget = CreateWidget<UUserWidget>(this, LoseGameClass);
        if (LoseWidget)
        {
